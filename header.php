 ...
 <head>
     ...
     <!-- Favicon -->
     <link rel="shortcut icon" href="assets/art_imgs/FINAL-LOGO.png" />
     <!-- Plugins CSS -->
                 ...
                 <div class="row">
                     ...
                     <div class="col-sm-4 col-md-4 col-lg-4 d-none d-lg-none d-md-block d-lg-block">
                         <div class="text-center">
                             <p class="top-header_middle-text">Welcome To www.Artdrop.com</p>
                         </div>
                     </div>
             ...
             <div class="container-fluid">
                 <div class="row align-items-center">
                     ...
                     <div class="logo col-md-2 col-lg-2 d-none d-lg-block">
                         <a href="index.php">
                             <img src="assets/art_imgs/FINAL-LOGO.png" alt="logo" title="logo" class="img-fluid" />
                         </a>
                     </div>
                     <!--End Desktop Logo-->
                     <div class=" col-sm-1 col-md-3 col-lg-6">
                         ...
                         <nav class="grid__item" id="AccessibleNav">
                             ...
                             <ul id="siteNav" class="site-nav medium center hidearrow">
                                 <li class="lvl1 parent megamenu active">
                                 ...
                                 <li class="lvl1 parent megamenu"><a href="aboutUs.php">About us </i></a>
                                 ...
                                 <li class="lvl1 parent dropdown"><a href="product_page.php">
                                         Products <i class="anm anm-angle-down-l"></i>
                                     </a>
                                     <ul class="dropdown  ">
                                         <li>
                                             <a href="#" class="site-nav">Painting
                                         ...
                                         <li>
                                             <a href="#" class="site-nav">Photography</a>
                                ...
                                <li class="lvl1 parent dropdown"><a href="#">Blog <i class="anm anm-angle-down-l"></i></a>
                                 ...
                                 <li class="lvl1"><a href="contact_us.php">Contact US </a></li>
                             </ul>
                         </nav>
                         <!--End Desktop Menu-->
                     </div>
                     <!--Mobile Logo-->
                     <div class=" col-sm-4 col-md-6 col-lg-2 d-block d-lg-none mobile-logo">
                         <div class="logo">
                             <a href="index.php">
                                 <img src="assets/art_imgs/FINAL-LOGO.png" alt="logo" title="logo" />
                             </a>
                         </div>
                     </div>
                     <!--Mobile Logo-->
                             ...
                             <ul class="list-inline">
                                 <li class="list-inline-item">
                                     <a class="social-icon text-xs-center" target="_blank" href="#">
                                         <img src="assets/art_imgs/Icons-Other-profile.png" alt="profile" class="img-fluid w-50">
                                     </a>
                                 </li>
                                 <li class="list-inline-item">
                                     <a class="social-icon text-xs-center" target="_blank" href="#">
                                         <img src="assets/art_imgs/Icons-Other-heart.png" alt="profile" class="img-fluid w-50">
                                             ...
                                             <ul class="mini-products-list">
                                                 <li class="item">
                                                     <a class="product-image" href="#">
                                                         <img src="assets/art_imgs/art_work.png" alt="paint" title="paint" class="img-fluid" />
                                                     </a>
                                                     <div class="product-details">
                                                         <a href="#" class="remove"><i class="anm anm-times-l" aria-hidden="true"></i></a>
                                                         <a href="#" class="edit-i remove"><i class="anm anm-edit" aria-hidden="true"></i></a>
                                                         <a class="pName" href="#">Painting</a>
                                                 ...
                                                 <li class="item">
                                                     <a class="product-image" href="#">
                                                         <img src="assets/art_imgs/order-cart.png" alt="paint" title="paint" class="img-fluid" />
                                                     </a>
                                                     <div class="product-details">
                                                         <a href="#" class="remove"><i class="anm anm-times-l" aria-hidden="true"></i></a>
                                                         <a href="#" class="edit-i remove"><i class="anm anm-edit" aria-hidden="true"></i></a>
                                 ...
                                 <li class="list-inline-item">
                                     <div id="mySidenav" class="sidenav">
                                         <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">
                                             <img src="assets/art_imgs/cross.png" alt="close" class="img-fluid w-50">
                                         </a>
                                         <a href="index.php">Home </a>
                                     ...
                                     <div id="main">
                                         ...
                                         <span onclick="openNav()" class="text-dark" style="cursor: pointer;">
             ...
             <ul id="MobileNav" class="mobile-nav">
                 ...
                 <li class="lvl1 parent megamenu"><a href="about-us.html">Pages <i class="anm anm-plus-l"></i></a>
                     <ul>
                         ...
                         <li><a href="contact_us.php" class="site-nav">Contact Us</a></li>
                         <li><a href="faqs.html" class="site-nav">FAQs</a></li>
