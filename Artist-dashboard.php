                         ...
                         <div class="row">
                             <div class="col-lg-12">
                                 ...
                                 <div class="row bg-white p-3">
                                     <div class="col-sm-1">
                                         <img src="assets/art_imgs/painting.png" alt="user" class="img-fluid ">
                                 ...
                                 <a href="#menu-toggle" class="btn btn-default bg-transparent text-dark d-lg-none d-sm-block" id="menu-toggle"> << </a>
